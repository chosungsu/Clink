...
content(
  ...
  PageController pageController =
      PageController(initialPage: s == 'home' ? 0 : 1);
                                                                    ...
                                                                    if (s ==
                                                                      ...
                                                                      choicelist[0] ==
                                                                          ...
                                                                          ? firestore.collection('CalendarSheetHome_update').add({
                                                                              ...
                                                                              'color': Hive.box('user_setting').get('typecolorcalendar') ?? _color.value.toInt(),
                                                                              'date': date.toString().split('-')[0] + '-' + date.toString().split('-')[1] + '-' + date.toString().split('-')[2].substring(0, 2) + '일'
                                                                            }).whenComplete(
                                                                              () {
                                                                              controll_memo.setloading(false);
                                                                              Get.back();
                                                                              Future.delayed(const Duration(seconds: 2), () {
                                                                                CreateCalandmemoSuccessFlushbar('정상적으로 추가됨', fToast);
                                                                              });
                                                                            })
                                                                          : firestore
                                                                              ...
                                                                              'security': false,
                                                                              'pinnumber': '0000',
                                                                              'EditDate': date.toString().split('-')[0] + '-' + date.toString().split('-')[1] + '-' + date.toString().split('-')[2].substring(0, 2) + '일',
