...
class RoutineScript extends StatefulWidget {
  RoutineScript({Key? key, required this.index, required this.cardindex})
      : super(key: key);
  final int index;
  final String cardindex;
  @override
  State<StatefulWidget> createState() => _RoutineScriptState();
}

class _RoutineScriptState extends State<RoutineScript> {
